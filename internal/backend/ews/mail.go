...
func (m mailSvc) Search(context.Context, string, backend.SearchOpts) ([]byte, error) {
	return nil, backend.ErrUnsupported
}
func (m mailSvc) Send(context.Context, string, mail.Message) error { return backend.ErrUnsupported }
func (m mailSvc) CreateDraft(context.Context, string, mail.Message) (string, error) {
